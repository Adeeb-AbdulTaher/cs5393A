...
10 Epochs Version - Quick Training
"""
import numpy as np
...
print("=" * 70)
print("DEEPRL4FL - CNN Fault Localization (10 Epochs - Quick Training)")
print("=" * 70)
...
model.save('combined/models/deeprl4fl_combined_10epochs.h5')
np.save('combined/models/predictions_10epochs.npy', y_pred)
np.save('combined/models/predictions_proba_10epochs.npy', y_pred_proba)
np.save('combined/models/test_labels_10epochs.npy', y_test)

import json
history_dict = {key: [float(v) for v in values] for key, values in history.history.items()}
with open('combined/models/training_history_10epochs.json', 'w') as f:
    json.dump(history_dict, f, indent=2)

print("   Model saved to 'combined/models/deeprl4fl_combined_10epochs.h5'")
print("\n" + "=" * 70)
